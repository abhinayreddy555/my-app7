...
export class AppDataService {
  ...
  private countries: Array<Country> = [
    ...
    { id: 2, name: "India", epiIndex: 84.25 },
    { id: 3, name: "Luxembourg", epiIndex: 83.29 },
    { id: 4, name: "Australia", epiIndex: 82.4 },
    { id: 5, name: "Singapore", epiIndex: 81.78 },
    { id: 6, name: "Czech Republic", epiIndex: 81.47 },
    { id: 7, name: "Germany", epiIndex: 80.47 },
    { id: 8, name: "Spain", epiIndex: 79.09 },
    { id: 9, name: "Austria", epiIndex: 78.32 },
    { id: 10, name: "Sweden", epiIndex: 78.09 },
